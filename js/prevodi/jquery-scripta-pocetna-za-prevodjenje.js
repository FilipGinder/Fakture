...
if(jezik == 'srpski' || jezik == 'Promeni_jezik' || jezik == null || jezik == "" || jezik == "undefined"){
  ...
  $("#izbor_godine").html('Sve fakture po godinama');
  ...
  $("#paragraf_za_placanje").html('UKUPAN&nbsp;IZNOS&nbsp;ZA&nbsp;UPLATU:&nbsp;&nbsp;<span id="za_placanje"></span>&nbsp;&nbsp;<span id="valuta"></span>');
  ...
  $("#obrisi_nalog").html('Obrisi nalog');
...
//  STRANICA GORE
  ...
  $("#izbor_godine").html('All invoices per year');
...
//STRANICA DOLE
  ...
  $("#paragraf_za_placanje").html('THE&nbsp;TOTAL&nbsp;AMOUNT&nbsp;TO&nbsp;BE&nbsp;PAID:&nbsp;<span id="za_placanje"></span>&nbsp;&nbsp;<span id="valuta"></span>');
